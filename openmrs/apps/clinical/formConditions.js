Bahmni.ConceptSet.FormConditions.rules = {
	...
	/*conditions pour le formulaire covid19*/

	'Are you pregnant': function(formName, formFieldValues, patient) {
    var conditions = {enable: [], disable: []};
    if (patient.gender === 'M') {
        conditions.disable.push("Are you pregnant");
    }
    return conditions;
	},

	'Have you tested for COVID19 recently': function(formName, formFieldValues) {
    var conditions = {show: [], hide: []};
	var value = formFieldValues['Have you tested for COVID19 recently'];
    if (value === true) {
        conditions.show.push("Covid19 Test date");
        conditions.show.push("Covid19 Test result");
    } else {
        conditions.hide.push("Covid19 Test date");
        conditions.hide.push("Covid19 Test result");
    }
    return conditions;
	},

	'Covid19 Test result': function(formName, formFieldValues) {
    var conditions = {show: [], hide: []};
    if (formFieldValues['Covid19 Test result'] === "Positive") {
        conditions.show.push("Number of people you have been in contact with");
        conditions.show.push("Phone numbers of persons you have been in contact with");
    } else {
        conditions.hide.push("Number of people you have been in contact with");
        conditions.hide.push("Phone numbers of persons you have been in contact with");
    }
    return conditions;
	},
